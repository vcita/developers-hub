...
### 4.2 Token Types & Authentication ⚠️ MANDATORY

**⚠️ CRITICAL: Token types MUST be determined by reading source code**

```
DO NOT:
- Copy token types from existing x-vcita-access extension
- Assume token types based on endpoint naming
- Rely on existing swagger description text
- Guess based on similar endpoints

ONLY USE:
- Authentication guards/decorators found in source code
- before_action filters in Rails controllers
- Auth module configuration
```

**Token Types Accepted:** (check all that apply based on **CODE VERIFICATION**)

| Token Type | Accepted? | Code Evidence (guard/decorator/before_action - REQUIRED) |
|------------|-----------|----------------------------------------------------------|
| Staff Token | ☐ Yes ☐ No | File: ______ Line: ______ Pattern: ______ |
| Directory Token | ☐ Yes ☐ No | File: ______ Line: ______ Pattern: ______ |
| App Token | ☐ Yes ☐ No | File: ______ Line: ______ Pattern: ______ |
| Client Token | ☐ Yes ☐ No | File: ______ Line: ______ Pattern: ______ |
| Operator Token | ☐ Yes ☐ No | File: ______ Line: ______ Pattern: ______ |

**Code Evidence Examples:**
- NestJS: `@UseGuards(StaffAuthGuard)` or `@AllowedActors([ActorType.STAFF])`
- Rails: `before_action :authenticate_staff!` or `current_staff`

**Token Availability Statement Added to Description?**
- [ ] Yes - Statement added at **end of description** in bold
- [ ] Format used: `Available for **[Token Type] tokens**`
- [ ] Token types match code evidence documented above

**Example:** `"description": "Get appointments list.\n\nAvailable for **Staff and Directory tokens**"`

**x-vcita-access extension:**
- [ ] N/A - Do not add, modify, or remove this extension (outside scope)

**Permissions (if applicable):**

| Permission | Required? | Code Evidence |
|------------|-----------|---------------|
| | ☐ Yes ☐ No | |
...
| Token Types | ☐ Added ☐ Modified ☐ None | |
...
- [ ] **Token types verified against code guards/decorators**
- [ ] **Token availability statement added to description**
