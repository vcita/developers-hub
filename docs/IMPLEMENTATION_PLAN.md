...
### In Scope (414 Endpoints across 53 Files)

| Domain | Endpoint Count | Swagger Files |
|--------|---------------|---------------|
| AI | 16 | 5 |
| Apps | 25 | 6 |
| Clients | 66 | 6 |
...
| Integrations | 10 | 2 |
| Payments | 5 | 2 |
| Platform Administration | 106 | 12 |
| Reviews | 3 | 1 |
| Sales | 99 | 6 |
| Scheduling | 40 | 5 |
| **TOTAL** | **414** | **53** |

### Complete Swagger File Inventory

#### AI Domain (16 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/ai/ai_generation_feedback.json` | 1 |
| `swagger/ai/ai_smart_reply.json` | 3 |
| `swagger/ai/bizai.json` | 5 |
| `swagger/ai/recommendations.json` | 5 |
| `swagger/ai/staff_ai_settings.json` | 2 |

#### Apps Domain (25 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/apps/apps.json` | 3 |
| `swagger/apps/jwks.json` | 2 |
| `swagger/apps/legacy/legacy_app_translation.json` | 1 |
| `swagger/apps/legacy/legacy_token.json` | 1 |
| `swagger/apps/legacy/legacy_v1_apps.json` | 8 |
| `swagger/apps/widgets_and_boards.json` | 10 |

#### Clients Domain (66 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/clients/client_settings.json` | 2 |
| `swagger/clients/legacy/client_communication.json` | 4 |
| `swagger/clients/legacy/clients_payments.json` | 16 |
| `swagger/clients/legacy/crm_views.json` | 8 |
| `swagger/clients/legacy/legacy_v1_clients.json` | 15 |
| `swagger/clients/legacy/manage_clients.json` | 21 |

#### Communication Domain (44 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/communication/activity_message.json` | 1 |
| `swagger/communication/business_phone_numbers.json` | 5 |
| `swagger/communication/communication.json` | 11 |
| `swagger/communication/legacy/communication.json` | 11 |
| `swagger/communication/legacy/legacy_v1_communication.json` | 7 |
| `swagger/communication/legacy/messages.json` | 2 |
| `swagger/communication/notification_template.json` | 5 |
| `swagger/communication/staff_notification.json` | 2 |

#### Integrations Domain (10 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/integrations/authbridge.json` | 6 |
| `swagger/integrations/import.json` | 4 |

#### Payments Domain (5 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/payments/creditNote.json` | 3 |
| `swagger/payments/invoice.json` | 2 |

#### Platform Administration Domain (106 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/platform_administration/access_control.json` | 15 |
| `swagger/platform_administration/legacy/accounts.json` | 6 |
| `swagger/platform_administration/legacy/legacy_v1_platform.json` | 26 |
| `swagger/platform_administration/legacy/oauth.json` | 2 |
| `swagger/platform_administration/legacy/partners-api.json` | 11 |
| `swagger/platform_administration/legacy/staff.json` | 2 |
| `swagger/platform_administration/license.json` | 25 |
| `swagger/platform_administration/online_profiles.json` | 4 |
| `swagger/platform_administration/operatorCapabilities.json` | 10 |
| `swagger/platform_administration/operatorTokens.json` | 1 |
| `swagger/platform_administration/staff.json` | 2 |
| `swagger/platform_administration/staff_member.json` | 2 |

#### Reviews Domain (3 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/reviews/business_reviews_settings.json` | 3 |

#### Sales Domain (99 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/sales/coupon.json` | 1 |
| `swagger/sales/legacy/client_cards.json` | 2 |
| `swagger/sales/legacy/legacy_v1_sales.json` | 30 |
| `swagger/sales/legacy/payments.json` | 58 |
| `swagger/sales/payment_gateway.json` | 6 |
| `swagger/sales/sales_reports.json` | 2 |

#### Scheduling Domain (40 endpoints)
| File | Endpoints |
|------|-----------|
| `swagger/scheduling/availability.json` | 2 |
| `swagger/scheduling/availability_slots.json` | 1 |
| `swagger/scheduling/legacy/legacy_v1_scheduling.json` | 10 |
| `swagger/scheduling/legacy/scheduling.json` | 17 |
| `swagger/scheduling/resource_management.json` | 10 |
...
|---------|------|---------|-----------------|
| `core` | `core/` | Primary Rails API implementation | `app/controllers/`, `modules/` |
| `apigw` | `apigw/` | Go API Gateway (routing, proxy) | `src/server/`, `src/config/` |
| `client-portal` | `client-portal/` | Vue.js client portal frontend | `client/src/` (frontend only) |
| `aiplatform` | `aiplatform/` | NestJS AI/BizAI service | `src/chats/`, `src/recommendations/`, `src/ai-generation-feedback/` |
| `communication-gw` | `communication-gw/` | Communication gateway service | `src/` |
| `notificationscenter` | `notificationscenter/` | Notifications service | `src/` |
| `phonenumbersmanager` | `phonenumbersmanager/` | Phone numbers management service | `src/` |
| `voicecalls` | `voicecalls/` | Voice calls service | `src/` |
| `app-widgets-manager` | `app-widgets-manager/` | App widgets management service | `src/` |
| `permissionsmanager` | `permissionsmanager/` | Permissions management service | `src/` |
| `subscriptionsmng` | `subscriptionsmng/` | Subscriptions management service | `src/` |
| `frontage` | `frontage/` | Angular/Vue frontend application | `app/assets/frontage/`, `pov/`, `vue/` |
| `vcita` | `vcita/` | Additional vcita services | Various |
...
│              │     │              │     │              │     │              │
│ - Find code  │     │ - Update     │     │ - JSON valid │     │ - PR review  │
│ - Verify     │     │   swagger    │     │ - No dup keys│     │ - Final OK   │
│   behavior   │     │ - Add        │     │ - Checklist  │     │              │
│              │     │   examples   │     │ - Peer check │     │              │
└──────────────┘     └──────────────┘     └──────────────┘     └──────────────┘
```

### 0.5 ⚠️ MANDATORY: JSON Validation Requirements

**CRITICAL:** All swagger file modifications MUST pass these validations before being considered complete:

#### 1. JSON Syntax Validation
```bash
# Validate JSON syntax for all swagger files
python3 -c "import json; json.load(open('swagger/path/to/file.json'))"
```

#### 2. Duplicate Key Detection (CRITICAL)
```bash
# Check for duplicate keys - JSON parsers silently ignore duplicates!
python3 << 'EOF'
import json
...
check_duplicate_keys('swagger/path/to/file.json')
EOF
```

#### 3. Common Duplicate Key Errors to Avoid

**❌ WRONG - Adding description when one already exists:**
```json
{
  "get": {
    "description": "Original description",
    "summary": "Get items",
    "description": "New description with token info"  // DUPLICATE KEY!
  }
}
```

**✅ CORRECT - Modify the existing description:**
```json
{
  "get": {
...
#### 4. Token Documentation Pattern

When adding token availability to endpoints:

1. **Find the existing description** in the endpoint
2. **Append** the token availability to the existing description
3. **Do NOT add a new description key**

**Example of correct modification:**

Before:
```json
"description": "Retrieves a list of items for the business."
```
...
#### 5. Validation Script for All Files

Run this after any swagger modifications:

```bash
cd /path/to/developers-hub && python3 << 'EOF'
import json
import os
...
errors = []
for root, dirs, files in os.walk('swagger'):
    for f in files:
        if f.endswith('.json'):
...
6. **Token Types Documentation** ⚠️ MANDATORY
   - [ ] **Document which token types are accepted for each endpoint**
   - [ ] Add token availability statement at the **end of the description** in bold format
   - [ ] **Verify token types by exploring source code** - do NOT rely on existing `x-vcita-access` or swagger documentation
   - [ ] Do NOT modify, add, or remove `x-vcita-access` extension (it's outside scope)

### ⚠️ MANDATORY: Token Types Reference

**Available Token Types:**

| Token Type | Description | Typical Use Case |
|------------|-------------|------------------|
| **Staff Token** | Authenticates as a specific staff member within a business | Staff-facing operations, scheduling, client management, AI features |
| **Directory Token** | Authenticates at the directory/business level | Business-wide operations, bulk operations, admin tasks |
| **App Token** | Authenticates a third-party application | App integrations, partner APIs, marketplace apps |
| **Client Token** | Authenticates as a specific client | Client self-service portals, client-facing operations |
| **Operator Token** | Authenticates platform operators | Platform administration, multi-tenant operations |

**⚠️ CRITICAL: Token Types Must Be Verified from Source Code**

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                                                                              │
│   🛑  TOKEN TYPE DOCUMENTATION RULES:                                       │
│                                                                              │
│       1. Token types MUST be determined by reading source code              │
│       2. DO NOT copy token types from existing x-vcita-access               │
│       3. DO NOT assume token types based on endpoint naming                 │
│       4. DO NOT rely on existing swagger description text                   │
│                                                                              │
│       ✅ ONLY USE: Authentication guards, decorators, before_actions        │
│          found in the actual controller/service code                        │
│                                                                              │
│   The x-vcita-access extension is OPTIONAL and outside our scope.           │
│   Do not add, modify, or remove it - just ignore it.                        │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
Every endpoint description MUST end with a token availability statement in **bold**:

```
"description": "Retrieve a list of smart replies with optional filtering.\n\nAvailable for **Staff tokens**"
```
...
| Scenario | Format |
|----------|--------|
| Single token type | `Available for **Staff tokens**` |
| Multiple token types | `Available for **Staff and Directory tokens**` |
| All token types | `Available for **Staff, Directory, and App tokens**` |
| With permissions | `Available for **Staff tokens** (requires `scheduling.read` permission)` |

**Reference Implementation:** See `swagger/ai/ai_smart_reply.json` for properly formatted token availability documentation.

**How to Verify Token Types in Source Code:**

**NestJS Services:**
```typescript
// Look for these decorators on controllers or methods:
@AllowedActors([ActorType.STAFF, ActorType.DIRECTORY])
@UseGuards(RoleAuthGuard(ActorType.STAFF))
@UseGuards(StaffAuthGuard)
@UseGuards(AppAuthGuard)
@UseGuards(DirectoryAuthGuard)

// Check OAuth module registration in app.module.ts:
OauthModule.register({ authExcludePaths: [...] })

// Check ReqAuthorization decorator usage:
@ReqAuthorization() auth: AuthorizationPayloadEntity
// Then trace how auth.actor.type is used
```

**Ruby on Rails (core):**
```ruby
# Look for these patterns in controllers:
before_action :authenticate_staff!
before_action :authenticate_directory!
before_action :authenticate_app!
before_action :authenticate_client!

# Check current user methods:
current_staff / current_directory / current_app / current_client

# Check base controller inheritance:
class Api::V3::BaseController < ApplicationController
  # authentication logic here
```

**Verification Process:**
1. Find the controller/service file for the endpoint
2. Check class-level guards/before_actions
3. Check method-level guards/before_actions  
4. Trace authentication logic to determine allowed token types
5. Document ONLY what the code explicitly allows
...
### Swagger Files (All under `swagger/` folder)
...
|----------|------|----------|--------------|--------|
| `core` | `core/` | Ruby/Rails | Platform v1, Business APIs, Scheduling, Clients, Sales, Communication | ✅ Available |
| `apigw` | `apigw/` | Go | API Gateway routing/proxy (not API logic) | ✅ Available |
| `client-portal` | `client-portal/` | Vue.js | Frontend only (no API implementation) | ✅ Available |
| `aiplatform` | `aiplatform/` | TypeScript/NestJS | AI, BizAI, Recommendations, Generation Feedback | ✅ Available |
| `communication-gw` | `communication-gw/` | TypeScript/NestJS | Communication gateway APIs | ✅ Available |
| `notificationscenter` | `notificationscenter/` | TypeScript/NestJS | Notification templates, Staff notifications | ✅ Available |
| `phonenumbersmanager` | `phonenumbersmanager/` | TypeScript/NestJS | Phone numbers, Business phone numbers | ✅ Available |
| `voicecalls` | `voicecalls/` | TypeScript/NestJS | Voice calls, Voice call settings | ✅ Available |
| `app-widgets-manager` | `app-widgets-manager/` | TypeScript/NestJS | Widgets, Staff widgets boards | ✅ Available |
| `permissionsmanager` | `permissionsmanager/` | TypeScript/NestJS | Access control, Permissions | ✅ Available |
| `subscriptionsmng` | `subscriptionsmng/` | TypeScript/NestJS | License, Subscriptions, Offerings | ✅ Available |
| `frontage` | `frontage/` | Angular/Vue | Frontend application | ✅ Available |
| `vcita` | `vcita/` | Various | Additional vcita services | ✅ Available |
...
| **Apps** | `core`, `app-widgets-manager` | `modules/apps/app/controllers/`, `app/controllers/platform/v1/` |
| **Clients** | `core` | `modules/clients/app/controllers/`, `app/controllers/platform/v1/clients_controller.rb` |
| **Communication** | `core`, `communication-gw`, `phonenumbersmanager`, `voicecalls` | `modules/messaging/app/controllers/` |
| **Integrations** | `core` | TBD - verify during implementation |
| **Operators** | `core`, `permissionsmanager` | TBD - verify during implementation |
| **Platform Admin** | `core`, `subscriptionsmng` | `modules/licenses/app/controllers/`, `app/controllers/platform/v1/` |
| **Reviews** | `core` | `app/controllers/api/v3/reviews/` |
| **Sales** | `core` | `modules/payments/app/controllers/` |
| **Scheduling** | `core` | `modules/scheduling/app/controllers/` |
...
- v3 Operators APIs - may be in `permissionsmanager` or separate service
- Some v3 Communication APIs - likely in `communication-gw`, `phonenumbersmanager`, or `voicecalls`
