...
const EVENT = "message/business_sent_message";
...
module.exports = {
  key: "message_business_sent_message",
  noun: "Message",
  display: {
    label: "New Message (Message/Business_Sent_Message)",
    description: "Triggers when an inTandem \"message/business_sent_message\" webhook fires.",
  },
  operation: {
    type: 'hook',
    performSubscribe,
