...
| icon | Icon identifier from the platform icon library. The full list of supported identifiers is published at "https://vcita.github.io/developers-hub/icons/" (machine-readable list: "https://vcita.github.io/developers-hub/icons/icon-names.json"). Pass the full class name (e.g., "icon-Dashboard_POV", "icon-Settings"). | string |  |
