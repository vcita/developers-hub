...
| trial_type | Indicates whether this subscription was created with a trial. expire: subscription has a trial period and will expire when it ends. no_trial: subscription was created without a trial. automatic_charge: reserved for future use. | string (enum: `no_trial`, `automatic_charge`, `expire`) |  |
