...
const REPO_PATHS = {
  ...
  aibusinessrules: `${GITHUB_BASE}/aibusinessrules`,
  phonenumbersmanager: `${GITHUB_BASE}/phonenumbersmanager`,
  'communication-gw': `${GITHUB_BASE}/communication-gw`,
  authnapplication: `${GITHUB_BASE}/authnapplication`,
  harbor: `${GITHUB_BASE}/harbor`,
  einvoicing: `${GITHUB_BASE}/einvoicing`,
...
const APIGW_ROUTING = {
  '/v3/ai/business_rules': 'aibusinessrules',
  '/v3/ai/': 'aiplatform',
  ...
  '/v3/scheduling/resource_bookings': 'core',
  '/v3/apps/widgets': 'app-widgets-manager',
  '/v3/apps/staff_widgets_boards': 'app-widgets-manager',
  '/v3/apps/compact_jws_tokens': 'authnapplication',
  '/v3/integrations/import_jobs': 'harbor',
  '/v3/integrations/import_job_items': 'harbor',
  '/v3/integrations/idp_actor_mappings': 'authnapplication',
  '/v3/payments/credit_notes': 'einvoicing',
  '/v3/payments/invoices': 'einvoicing',
  '/v3/payments/client_payment_cards': 'core',
  '/v3/sales/': 'core',
  '/v3/reviews/': 'core',
  '/v3/clients/': 'core',
  '/v3/staff': 'core',
  ...
  '/business/payments/': 'core',
  '/business/staffs/': 'core',
  '/business/clients/': 'core',
  '/business/messaging/': 'core',
  '/client/payments/': 'core',
  '/platform/v1/': 'core',
  '/v2/': 'core',
  '/v1/': 'core',
};
...
const REPO_FRAMEWORKS = {
  ...
  vcita: 'rails',
  aiplatform: 'nestjs',
  aibusinessrules: 'nestjs',
  subscriptionsmng: 'nestjs',
  voicecalls: 'nestjs',
  phonenumbersmanager: 'nestjs',
  notificationscenter: 'nestjs',
  availability: 'nestjs',
  resources: 'nestjs',
  permissionsmanager: 'nestjs',
  'app-widgets-manager': 'nestjs',
  'communication-gw': 'nestjs',
  authnapplication: 'nestjs',
  harbor: 'nestjs',
  einvoicing: 'nestjs',
};
