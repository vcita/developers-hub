...
```json
{
  "uid": {
    ...
    "extract_from": "first subscription uid from list or created subscription uid",
    "fallback_endpoint": "POST /v3/license/subscriptions",
    "create_fresh": false,
    "create_endpoint": "POST /v3/license/subscriptions",
    "create_body": {
      "offering_uid": "9e50084f-094e-4525-9886-8ad5b4e62037",
      "business_uid": "88pzdbz1hmkdoel4",
      "purchase_currency": "USD"
    },
    "cleanup_endpoint": "No DELETE endpoint available",
    "cleanup_note": "Subscription cleanup not available - created test entities remain"
  }
}
```
