---
endpoint: "PUT /business/scheduling/v1/external_calendar_items/stop_import"
domain: scheduling
tags: [calendar, sync, external, scheduling]
swagger: "swagger/scheduling/legacy/scheduling.json"
status: verified
savedAt: "2026-02-03T20:00:00.000Z"
...
steps:
  - id: stop_import
    description: "Stop importing from external calendar"
    method: PUT
    path: "/business/scheduling/v1/external_calendar_items/stop_import"
    token: staff
    body:
      staff_uid: "{{staff_uid}}"
      calendar_sync:
