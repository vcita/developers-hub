...
steps:
  ...
  - id: bulk_create_items
    description: "Create items to deactivate"
    method: PUT
...
| `external_items_to_deactivate` | Yes | array | Array of items to deactivate |
| `external_items_to_deactivate[].external_id` | Yes | string | External provider's item ID |
