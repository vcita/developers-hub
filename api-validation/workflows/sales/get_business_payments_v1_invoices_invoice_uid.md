---
endpoint: GET /business/payments/v1/invoices/{invoice_uid}
domain: sales
tags: []
swagger: swagger/sales/legacy/payments.json
status: verified
savedAt: 2026-02-06T18:11:37.945Z
verifiedAt: 2026-02-07T07:47:11.000Z
timesReused: 0
---
# Get Invoices
...
Retrieves an invoice after creating one via prerequisites.
...
steps:
  ...
  - id: create_invoice
    description: "Create an invoice to retrieve"
    method: POST
...
|--------|--------------|-----------------|----------|
| missing_field: invoice_uid | Documented as path param {invoice_uid} | Controller expects params[:id]; route likely maps invoice_uid to :id | - |
